<x-app-layout>
    ...
    <div class="container mx-auto mt-7">
        <div class="justify-end flex mt-3 border-b-2 border-blue-500 py-5">
            <button class="bg-blue-500  px-8 py-2 text-white rounded-md hover:bg-white hover:text-blue-400 border-2 border-blue-500">Ajouter</button>
        </div>
        <div class=" border-b-2 border-blue-500 px-5 mt-4 space-y-8">
            <div class="py-5 flex items-center justify-between">
                ...
                <div class="space-x-3">
                    <button class="bg-blue-500 text-white border-2 hover:bg-white hover:border-blue-500 hover:text-blue-400 rounded-md px-4 py-1">Modifier</button>
